              ...
              <div className="foto-info">
                ...
                <ul className="foto-info-comentarios">
                  ...
                  <li className="comentario">
                    ...
                    voluptatem modi nihil sit magnam ratione eveniet distinctio magni error asperiores dignissimos
                    tempora expedita, laborum ex soluta hic maiores veritatis deserunt.
                  </li>
                  <li className="comentario">
                    <a className="foto-info-autor">seguidor </a>
